...
/**
 * @details Fires up when the Devices completes booting up. It sets the pending
 *          intent at that time.
 */
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (cur.moveToFirst()) {
            ...
            if (cur.getLong(cur.getColumnIndex(DBAdapter.KEY_TIME_MILLIS)) > System.currentTimeMillis()) {
                ...
                // When a devices boots up and this broadcast receiver fires up,
                // there's a delay for the device to get functional as in
                // network and services. So we set the Pending Intent with a
                // delay of 3 minutes ~ 180000 milliseconds.
