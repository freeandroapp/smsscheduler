...
public class SentReceiver extends BroadcastReceiver {
    ...
    /**
     * @details calculates the Next schedule time based upon the supplied
     *          repeatHash, repeadMode and timeInMillis of previous sent.
     * @param repeatHash
     * @param repeatMode
     * @param previousTimeInMillis
     * @return time in millis for the next scheduling. A '0' value means end of
     *         repetition scheme, no more repeats required.
     */
        ...
        case 2:
            ...
            if ((weekBools.get(0) || weekBools.get(1) || weekBools.get(2) || weekBools.get(3) || weekBools.get(4) || weekBools.get(5) || weekBools.get(6))) {
                ...
                while (dayNotFound) {
                    ...
                    if ((dow == Calendar.SUNDAY && weekBools.get(0)) || (dow == Calendar.MONDAY && weekBools.get(1)) || (dow == Calendar.TUESDAY && weekBools.get(2)) || (dow == Calendar.WEDNESDAY && weekBools.get(3)) || (dow == Calendar.THURSDAY && weekBools.get(4)) || (dow == Calendar.FRIDAY && weekBools.get(5)) || (dow == Calendar.SATURDAY && weekBools.get(6))) {
