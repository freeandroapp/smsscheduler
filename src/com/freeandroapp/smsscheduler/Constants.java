...
public class Constants {
    ...
    // ------------ Statics for HashMap to store detail of Contact Groups to
    // show in Expandable list --------------
    ...
    public static final String DIALOG_CONTROL_ACTION = "com.freeandroapp.smsscheduler.DIALOG_CONTROL_ACTION";
