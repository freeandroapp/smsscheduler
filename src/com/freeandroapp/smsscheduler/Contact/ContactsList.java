...
import com.freeandroapp.smsscheduler.activities.Home;
...
public class ContactsList extends Activity {
    ...
    protected void onStart() {
        ...
        // if Contacts have been modified from the Native Contact app, the
        // Contacts List is to be reloaded, serialized and saved in the shared
        // prefs.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // This Activity can be called for two purposes, to create a Group or
        // edit a Group. We have to treat these two situations differently. For
        // that purpose, we are supplied with an Intent Extra called
        // "ORIGINATOR".
        ...
        if (callingActivity.equals("Group Edit Activity")) {
            // case: called for Edit, we must back up the original values. So,
            // we make a clone of values and use them to prepare the initial
            // state of the list.
            idsString.clear();
                ...
                if (callingActivity.equals("Group Add Activity")) {
                    if (ids.size() == 0) {
                        ...
                        if (groupName.equals("")) {
                            ...
                            if (ids.size() == 0) {
                                // case: if no Contact have been selected to
                                // include in the Group, can't create the Group.
    ...
    private class ContactListAdapter extends ArrayAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (contacts.get(position).numbers.size() > 1) {
                ...
                // Create an Extra Number View for each extra number and store
                // them in an ArrayList<View>
