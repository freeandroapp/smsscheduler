...
public class DisplayImage {
    ...
    /**
     * @details starts off assigning of an image to an ImageView on a background
     *          thread.
     * @param iv
     * @param contactId
     * @param context
    ...
    /**
     * @details stores image for a particular contactId into a HashMap that is
     *          shown in the list. If no image is available for the contact, it
     *          is assigned a default thumbnail for "No Image".
     * @param contactId
    ...
    /**
     * @details runs on another thread and adds an image to an ImageView. First
     *          it gets the bitmap against a particular contactId, then puts it
     *          into an ImageView.
     */
    ...
    /**
     * @details to get image against a particular contactId that is stored in
