...
package com.freeandroapp.smsscheduler.activities.Group;
...
import com.freeandroapp.smsscheduler.Contact.ContactsList;
...
public class EditGroup extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * @details Clicking on this label, pops up a Dialog which lets you
        ...
        /**
         * @details to add new contacts to the current group, on the click of
         *          this button screen navigates to ContactsList Activity in
         *          Edit mode. List of current Ids and groupId are passed.
         */
    ...
    /**
     * @details Organizes the ids of members into a more convenient structure,
     *          an ArrayList of GroupMember class.
     * @param ids
     * @param numbers
